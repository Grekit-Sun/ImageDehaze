package com.yifan.dehaze.helper;
...
public class WeakHandlerHelper {
     ...
     */
    public WeakHandlerHelper(@Nullable Handler.Callback callback) {
     ...
     */
    public WeakHandlerHelper(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public WeakHandlerHelper(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
